...
class Constants {
  static const creamColor = Color(0xffF3EFE0);
  ...
  static const qualityExpDescription =
      "Specialize in building high-performance, responsive, and elegant mobile applications using the Flutter framework and Dart programming language.";
